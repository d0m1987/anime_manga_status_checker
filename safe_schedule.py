# Credits to https://gist.github.com/mplewis/8483f1c24f2d6259aef6
        ...
        try:
            ...
            if(self.reschedule_on_failure):
                if(self.minutes_after_failure!=0 or self.seconds_after_failure!=0):
                    ...
                    job.last_run = None
                    job.next_run = datetime.now() + datetime.timedelta(minutes=self.minutes_after_failure, seconds=self.seconds_after_failure)
                else:
